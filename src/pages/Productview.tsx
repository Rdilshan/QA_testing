                                            ...
                                            <div className="product-thumb-carousel owl-carousel owl-loaded owl-drag">
                                                ...
                                                <div className="owl-stage-outer">
                                                    <div
                                                        className="owl-stage"
                                                        style={{
                                                            transform: 'translate3d(-1338px, 0px, 0px)',
                                                    ...
                                                    >
                                                        ...
                                                        <div className="owl-item cloned" style={{ width: '446.025px' }}><div className="single-thumb-item">
                                                            <a href="single-product.html"><img className="img-fluid" src="src/assets/img/single-pro-thumb-3.jpg" alt="Product" /></a>
                                                        </div></div><div className="owl-item cloned" style={{ width: '446.025px' }}><div className="single-thumb-item">
                                                            <a href="single-product.html"><img className="img-fluid" src="src/assets/img/single-pro-thumb-4.jpg" alt="Product" /></a>
                                                        </div></div><div className="owl-item cloned" style={{ width: '446.025px' }}><div className="single-thumb-item">
                                                            <a href="single-product.html"><img className="img-fluid" src="src/assets/img/single-pro-thumb-5.jpg" alt="Product" /></a>
                                                        </div></div><div className="owl-item active" style={{ width: '446.025px' }}><div className="single-thumb-item">
                                                            <a href="single-product.html"><img className="img-fluid" src="src/assets/img/single-pro-thumb.jpg" alt="Product" /></a>
                                                        </div></div><div className="owl-item" style={{ width: '446.025px' }}><div className="single-thumb-item">
                                                            <a href="single-product.html"><img className="img-fluid" src="src/assets/img/single-pro-thumb-2.jpg" alt="Product" /></a>
                                                        </div></div><div className="owl-item" style={{ width: '446.025px' }}><div className="single-thumb-item">
                                                            <a href="single-product.html"><img className="img-fluid" src="src/assets/img/single-pro-thumb-3.jpg" alt="Product" /></a>
                                                        </div></div><div className="owl-item" style={{ width: '446.025px' }}><div className="single-thumb-item">
                                                            <a href="single-product.html"><img className="img-fluid" src="src/assets/img/single-pro-thumb-4.jpg" alt="Product" /></a>
                                                            ...
                                                            <a href="single-product.html"><img className="img-fluid" src="src/assets/img/single-pro-thumb-3.jpg" alt="Product" /></a>
                                                        </div></div></div></div><div className="owl-nav"><button type="button" role="presentation" className="owl-prev"><i className="fa fa-angle-left"></i></button><button type="button" role="presentation" className="owl-next"><i className="fa fa-angle-right"></i></button></div><div className="owl-dots disabled"></div><div className="owl-thumbs"><button className="owl-thumb-item active"><img src="src/assets/img/single-pro-thumb.jpg" alt="Product" /></button><button className="owl-thumb-item"><img src="src/assets/img/single-pro-thumb-2.jpg" alt="Product" /></button><button className="owl-thumb-item"><img src="src/assets/img/single-pro-thumb-3.jpg" alt="Product" /></button><button className="owl-thumb-item"><img src="src/assets/img/single-pro-thumb-4.jpg" alt="Product" /></button><button className="owl-thumb-item"><img src="src/assets/img/single-pro-thumb-5.jpg" alt="Product" /></button></div></div>
                                        </div>
                                    </div>
